...
CUDA_VISIBLE_DEVICES=0 python main.py --train_scenes brandenburg_gate,colosseum_exterior,grand_place_brussels,hagia_sophia_interior,palace_of_westminster,pantheon_exterior,prague_old_town_square,taj_mahal,trevi_fountain,temple_nara_japan \
                                      --valid_gt /home/hieu123/nghia/src/training/valid/yfcc_test_pairs_with_gt.txt
#CUDA_VISIBLE_DEVICES=0 python main.py --train_scenes buckingham_palace \
#                                      --valid_gt /home/hieu123/nghia/src/training/valid/yfcc_buckingham_palace.txt
